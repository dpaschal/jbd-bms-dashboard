...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self) -> None:
        ...
        middle.setAlignment(self._cells_widget, Qt.AlignmentFlag.AlignTop)
        ...
        middle.addWidget(self._fets_flags, stretch=3)
        middle.setAlignment(self._fets_flags, Qt.AlignmentFlag.AlignTop)
